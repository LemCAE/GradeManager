...
void query_course(Course clist[], int ccount, int *crsPos);               // 按课号或课程名查询课程
void query_cjlist(Score cjlist[], int cjcount, Course clist[], int ccount, Student slist[], int scount, Select sclist[], int sccount); // 按学号查询成绩单（含排名）
